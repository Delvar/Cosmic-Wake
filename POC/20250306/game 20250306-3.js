...
class HeadsUpDisplay {
    constructor(ship, celestialBodies, canvasWidth, canvasHeight) {
        ...
        this.gateRingRadius = this.ringRadius * 1.5; // Larger ring for gates
    }
    ...
    resize(canvasWidth, canvasHeight) {
        ...
        this.gateRingRadius = this.ringRadius * 1.5;
    }
    ...
    draw(context, camera) {
        ...
        context.strokeStyle = 'rgba(0, 255, 0, 0.3)'; // Green ring
        context.lineWidth = 2;
        context.stroke();
        context.closePath();
...
class Game {
    ...
    render() {
        ...
        this.currentSystem.celestialBodies.forEach(body => body.draw(this.context, this.camera, this.playerShip.position));
