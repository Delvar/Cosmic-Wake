...
export class AsteroidBelt {
     ...
     * @param {Object} starSystem - The star system containing this belt.
    ...
    draw(ctx, camera) {
        ...
        ctx.lineWidth = 1;
        this.backgroundAsteroids.forEach(asteroid => {
            const worldPos = new Vector2D(Math.cos(asteroid.angle) * asteroid.radius, Math.sin(asteroid.angle) * asteroid.radius);
