        ...
        this.galaxy.forEach(system => {
            ...
            // Despawn excess landed ships if above maxAIShips
                ...
                while (despawned < excessCount && landedShips.length > 0) {
                    ...
                    shipToDespawn.targetPlanet.removeLandedShip(shipToDespawn);
